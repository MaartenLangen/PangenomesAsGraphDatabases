...
def convert(gfffile, outputfile, fastafile, is_ignore_overlapping):
    ...
    with open(outputfile, 'w') as outfile:
        ...
        for entry in parsed_gff.all_features(featuretype=(),
            ...
            # Filter which features to be included
            if "CDS" not in entry.featuretype and "pseudogene" not in entry.featuretype and "tRNA" not in entry.featuretype: continue
